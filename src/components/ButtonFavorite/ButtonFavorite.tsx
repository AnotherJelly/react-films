...
export function ButtonFavorite({ film }: { film: Film}) {
  const [isOpen, setIsOpen] = useState(false);
  const { isFavorite, toggleFavorite } = useFavorite(film);
  ...
  return (
    <>
      <button 
        ...
        title={title}
      >
        <svg fill={isFavorite ? 'var(--color-red)' : 'var(--foreground)'} xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 1280.000000 1189.000000" preserveAspectRatio="xMidYMid meet">
